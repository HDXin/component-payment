...
public class SettingInfoDTOExample {
     ...
     * @project https://github.com/itfsw/mybatis-generator-plugin
     */
    public SettingInfoDTOExample limit(Integer rows) {
        this.rows = rows;
        return this;
    }
     ...
     * @project https://github.com/itfsw/mybatis-generator-plugin
     */
    public SettingInfoDTOExample limit(Integer offset, Integer rows) {
        this.offset = offset;
        this.rows = rows;
        return this;
    }
     ...
     * @project https://github.com/itfsw/mybatis-generator-plugin
     */
    public SettingInfoDTOExample page(Integer page, Integer pageSize) {
