...
public class ConfigInfoDTOExample {
     ...
     * @project https://github.com/itfsw/mybatis-generator-plugin
     */
    public ConfigInfoDTOExample limit(Integer rows) {
        this.rows = rows;
        return this;
    }
     ...
     * @project https://github.com/itfsw/mybatis-generator-plugin
     */
    public ConfigInfoDTOExample limit(Integer offset, Integer rows) {
        this.offset = offset;
        this.rows = rows;
        return this;
    }
     ...
     * @project https://github.com/itfsw/mybatis-generator-plugin
     */
    public ConfigInfoDTOExample page(Integer page, Integer pageSize) {
